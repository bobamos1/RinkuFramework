...
.Add(new SingleValCondCol<bool>("Quarantine", "sr.Quarantine"))
.Add(new SingleValCondCol<int>("SourceID", "b.SourceID"))
.Add(new SingleValCondCol<int>("BoxTypeID", "b.BoxTypeID"))
.Add(new SingleValCondCol<string>("BatchNB", "sr.Name"))
.Add(new RefValCondCol<int, string>("Product", "b.ProductID", "CONCAT(pr.Code, ':', pr.Name)"))
.Add(new SingleValCondCol<string>("Type", "bt.Name"))
//.Add(new SingleValCondCol<DateTime>("Date", "b.Date"))
.Add(new SingleValCondCol<decimal>("Gross", "b.Gross"))
.Add(new SingleValCondCol<decimal>("Tare", "b.Tare"))
.Add(new SingleValCondCol<decimal>("Net", "(b.Gross - b.Tare)"))
.Add(new NullRefValCondCol<int, string>("User", "b.UserID", "CASE WHEN b.UserID IS NULL THEN NULL ELSE CONCAT(u.Firstname, ' ', u.Lastname) END"))
.Add(new NullRefValCondCol<int, string>("Status", "b.StatusID", "CASE WHEN b.StatusID IS NULL THEN NULL ELSE CONCAT(s.Name, ' (', sg.Name, ')') END"))
.Add(new SingleValCondCol<string>("StatusColor", "sg.Color"))
.Add(new RefValCondCol<int, string>("Station", "b.StationID", "st.Name"))
